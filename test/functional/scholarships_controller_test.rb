...
class ScholarshipsControllerTest < ActionController::TestCase
  ...
  test "should create scholarship" do
    assert_difference('Scholarship.count') do
      post :create, scholarship: { amount: @scholarship.amount, description: @scholarship.description, quantity: @scholarship.quantity, title: @scholarship.title }
    end
  ...
  test "should update scholarship" do
    put :update, id: @scholarship, scholarship: { amount: @scholarship.amount, description: @scholarship.description, quantity: @scholarship.quantity, title: @scholarship.title }
    assert_redirected_to scholarship_path(assigns(:scholarship))
  end
